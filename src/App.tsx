...
export default function App() {
  ...
  useEffect(() => {
    ...
    const unsubCourses = onSnapshot(
      qCourses,
      (snap) => {
        const fetchedCourses = snap.docs.map((d) => ({
          id: d.id,
          ...d.data(),
        })) as Course[];
          ...
          <div className="flex-1 p-12 flex flex-col justify-center">
            <div className="mb-12">
              <button
                ...
                className="text-gray-400 hover:text-primary flex items-center gap-2 text-sm mb-8 transition-colors"
              >
              ...
              <p className="text-gray-400 text-sm mt-4">
                Log in to manage courses, instructors, and registrations.
              </p>
            </div>
          ...
          <div className="flex-1 bg-primary relative hidden md:block">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-12 text-center">
              ...
              <p className="text-white/80 text-sm leading-relaxed max-w-xs">
                Empowering academic excellence through seamless management and real-time data
                insights.
              </p>
            </div>
          </div>
      ...
      <div className="min-h-screen bg-[#f5f5f0] flex flex-col md:flex-row">
        ...
        <main className="flex-1 p-4 md:p-8 overflow-y-auto">
          <AnimatePresence mode="wait">
            ...
            >
              {activeTab === 'dashboard' && (
                <Dashboard academicYears={academicYears} courses={courses} user={user} />
              )}
              {activeTab === 'courses' && (
                <CourseManagement academicYears={academicYears} courses={courses} />
              )}
              {activeTab === 'instructors' && <InstructorMaster user={user} />}
              {activeTab === 'registrations' && (
                <Registrations academicYears={academicYears} courses={courses} user={user} />
              )}
    ...
    <div className="min-h-screen bg-[#f5f5f0] flex flex-col">
      <header className="bg-white border-b border-gray-200 px-6 py-4 flex justify-between items-center sticky top-0 z-30">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-lg serif leading-tight text-gray-900">
              BU Academic Training
            </h1>
          ...
          <div className="max-w-2xl mx-auto mb-8 p-4 bg-red-50 border border-red-100 rounded-2xl flex items-center gap-3 text-red-800">
            ...
            <div>
              ...
              <p className="text-[10px] opacity-70 mt-1">
                หากคุณใช้ iOS/Safari/Chrome บนมือถือ กรุณาตรวจสอบการตั้งค่า
                &quot;Prevent Cross-Site Tracking&quot; หรือแนะนำให้ทำการ Deploy แอปเพื่อใช้งานจริง
              </p>
            </div>
          </div>
        )}
